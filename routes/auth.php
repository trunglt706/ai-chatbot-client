...
use App\Http\Controllers\Auth\OtherController;
...
Route::get('other/{slug}', [OtherController::class, 'index']);

Route::middleware('guest')->group(function () {
    Route::get('/account-blocked', function () {
        return view('auth.blocked_account');
    ...
    Route::post('/auth/facebook/delete', [SocialiteController::class, 'dataDeletionCallbackFacebook'])->name('facebook.delete.data');
