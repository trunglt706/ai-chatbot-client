<x-app-layout>
                    ...
                    <form action="{{ route('contacts.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="content" class="form-label fw-semibold">
                                {{ __('Contact content') }} <span class="text-danger">*</span>
                            </label>
                            {{-- Hidden input for Trix to store content --}}
    ...
    {{-- JavaScript to show/hide module list --}}
    <script>
        function toggleModuleSelection() {
            ...
            if (selectedType === 2 || selectedType === 3) {
                ...
                // Reset module_id value when hidden
