<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="update_password_current_password" name="current_password" type="password" class="block w-full"
        ...
        <div>
            ...
            <div class="flex items-center">
                ...
                {{-- Nút refresh Captcha --}}
                <button type="button"
                    class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 refresh-captcha-btn">
                    {{ __('Refresh Captcha') }}
                </button>
            </div>
