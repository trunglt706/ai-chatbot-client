...
<body class="bg-light text-dark d-flex p-4 align-items-center justify-content-center min-vh-100 flex-column">
    <header class="w-100 mx-auto text-secondary mb-4" style="max-width: 900px;">
        @if (Route::has('login'))
            <nav class="d-flex align-items-center justify-content-end gap-3">
                @auth
                    <a href="{{ url('/dashboard') }}" class="btn btn-outline-dark px-4 py-2 rounded-1">
                        Dashboard
                    </a>
                @else
                    <a href="{{ route('login') }}" class="btn btn-outline-dark px-4 py-2 rounded-1">
                        Log in
                    </a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="btn btn-outline-dark px-4 py-2 rounded-1">
                            Register
                        </a>
                    @endif
                @endauth
    ...
    <div class="d-flex align-items-center justify-content-center w-100 transition-opacity opacity-100">
        <main class="d-flex flex-column flex-lg-row w-100 mx-auto" style="max-width: 900px;">
            <div class="flex-grow-1 p-4 pb-5 bg-white shadow rounded-bottom rounded-lg rounded-lg-0 rounded-start-lg">
                <h1 class="mb-2 fw-semibold fs-4">Let's get started</h1>
                <p class="mb-3 text-secondary">Laravel has an incredibly rich ecosystem. <br>We suggest starting with
                    the following.</p>
                <ul class="list-unstyled mb-4">
                    <li class="d-flex align-items-center gap-3 py-2 position-relative">
                        <span class="position-relative py-1 bg-white">
                            <span
                                class="d-flex align-items-center justify-content-center rounded-circle bg-light shadow border border-secondary"
                        ...
                        <span>
                            ...
                            <a href="https://laravel.com/docs" target="_blank"
                                class="fw-semibold text-decoration-underline text-danger ms-1">
                                Documentation
                ...
                <ul class="d-flex gap-3">
                    <li>
                        <a href="https://cloud.laravel.com" target="_blank" class="btn btn-dark px-4 py-2 rounded-1">
                            Deploy now
                        </a>
                    </li>
                </ul>
            </div>
            <div class="bg-danger-subtle position-relative rounded-top rounded-lg rounded-lg-0 rounded-end-lg overflow-hidden d-flex align-items-center justify-content-center"
                style="width: 100%; max-width: 438px; min-height: 376px;">
                {{-- Laravel Logo --}}
                <svg class="w-100 text-danger" viewBox="0 0 438 104" fill="none" xmlns="http://www.w3.org/2000/svg">
